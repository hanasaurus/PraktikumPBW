...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("sssid", $_POST['judul'], $_POST['sutradara'], $_POST['genre'], $_POST['tahun'], $_POST['rating']);
...
<head>
    ...
    <style>body { background-color: #FDF5E6; padding: 50px; } .card { border-radius: 15px; border-top: 8px solid #FF8C00; max-width: 500px; margin: auto; } .btn-orange { background-color: #FF8C00; color: white; font-weight: bold; }</style>
</head>
<body>
    <div class="card shadow p-4 border-0">
        ...
        <form method="POST">
            ...
            <div class="row">
                <div class="col-6"><label>Tahun</label><input type="number" name="tahun" class="form-control" required></div>
                <div class="col-6"><label>Rating</label><input type="number" step="0.1" name="rating" class="form-control" required></div>
            </div>
