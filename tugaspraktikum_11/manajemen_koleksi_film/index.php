...
<head>
    ...
    <style>
        ...
        .header-box { background-color: var(--orange); color: white; padding: 2rem; border-bottom: 5px solid var(--orange-dark); margin-bottom: 2rem; position: relative; }
        ...
        .btn-logout { position: absolute; top: 20px; right: 20px; background-color: white; color: var(--orange); font-weight: bold; border: none; padding: 5px 15px; border-radius: 5px; text-decoration: none; }
    </style>
</head>
<body>
<div class="header-box text-center shadow">
    <a href="logout.php" class="btn-logout shadow-sm" onclick="return confirm('Yakin ingin keluar?')">LOGOUT</a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><span class="badge bg-orange rounded-pill"><?= htmlspecialchars($row['genre']) ?></span></td>
